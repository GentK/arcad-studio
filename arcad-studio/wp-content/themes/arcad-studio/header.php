...
<head>
    ...
    <!-- CSS-->
    <link rel="apple-touch-icon" sizes="60x60" href="F/favicons/apple-touch-icon.png">
    ...
    <link rel="manifest" href="<?= get_stylesheet_directory_uri() ?>/favicons/site.webmanifest">
    <link rel="mask-icon" href="<?= get_stylesheet_directory_uri() ?>/favicons/safari-pinned-tab.svg" color="#5bbad5">
    <meta name="msapplication-TileColor" content="#da532c">
    <meta name="theme-color" content="#ffffff">
    <link rel="stylesheet" href="<?= get_stylesheet_directory_uri() ?>/css/bootstrap-grid.css">
    <link rel="stylesheet" href="<?= get_stylesheet_directory_uri() ?>/css/revolution.css">
    <link rel="stylesheet" href="<?= get_stylesheet_directory_uri() ?>/css/main.css">
    <title>Arcad Arcutecture Studio</title>
</head>
<header class="header header--half __js_no-static __js_fixed-header">
    <div class="header__inner">
        <!-- Logo-->
        <a class="header__logo logo">
            <span class="logo__large">Arcad</span>
        ...
        <nav class="mobile-canvas__nav navigation">
            <ul class="navigation__list">
                ...
                <li class="navigation__item navigation__item--current">
                    <a class="navigation__link" href="<?= home_url() ?>">Home</a>
                </li>
                <li class="navigation__item">
                    <a class="navigation__link animsition-link" href="<?= get_permalink( get_page_by_path( 'about' ) ) ?>">About</a>
                </li>
                <li class="navigation__item">
                    <a class="navigation__link animsition-link" href="<?= get_permalink( get_page_by_path( 'projects' ) ) ?>">Projects</a>
                </li>
                <li class="navigation__item">
                    <a class="navigation__link animsition-link" href="<?= get_permalink( get_page_by_path( 'contact' ) ) ?>">Contact</a>
                </li>
            </ul>
        </nav>
